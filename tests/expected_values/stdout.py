...
EXP_STDOUT = {'process_stdout': {1: "Process complete in 0.03 seconds.",
              ...
              'bigger_process_stdout': {1: 'Bigger process complete in 0.05 seconds.\n',
                                        ...
                                        3: '\n\r[                    ] 0%  Initialising '
                                           ...
                                           '|Process step 1: 0.01\n'
                                           '|Process step 2: 0.01\n'},
              'iterative_process_stdout': {1: 'Iterative process complete in 0.31 seconds.\n',
                                           ...
                                           3: '\n'
                                              ...
                                              '[==========          ] 50%  Iterator step '
                                              '1                                  \r'
                                              '[==========          ] 50%  Iterator step 2 for iteration '
                                              '0                  \r'
                                              '[==========          ] 50%  Iterator step '
                                              '1                                  \r'
                                              '[==========          ] 50%  Iterator step 2 for iteration '
